...
!-----|--1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2----+----3-|
       ...
       real(kind=dblp),  parameter, public  :: var = 0.1_dblp     !! Descrition variable var [unit]
       integer(kind=ip), parameter, public  :: var2 = 0           !! Description variable var2 [unit]

       ! people -- Variables only required for this module
       integer(kind=ip), PARAMETER :: var3 = 4                    !! Description variable var3 [unit]
       real(kind=dblp)             :: var4                        !! Description variable var4 [unit]
